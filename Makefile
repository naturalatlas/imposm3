...
VERSION_LDFLAGS=-X github.com/naturalatlas/imposm3.Version=$(BUILD_VERSION)
...
%.pb.go: %.proto
	protoc --proto_path=$(GOPATH)/src:$(GOPATH)/src/github.com/naturalatlas/imposm3/vendor/github.com/gogo/protobuf/protobuf:. --gogofaster_out=. $^
