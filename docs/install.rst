...
`Binary releases are available at GitHub. <https://github.com/naturalatlas/imposm3/releases>`_
...
Please see `the README for build instructions <https://github.com/naturalatlas/imposm3/#installation>`_.
